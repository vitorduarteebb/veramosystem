...
# Script para corrigir rotas faltantes na VPS
# Execute na VPS como root

echo "🛣️ CORREÇÃO DE ROTAS FALTANTES"
echo "=============================="
...
# 2. Verificar arquivo de URLs atual
echo "📋 1. VERIFICANDO ARQUIVO DE URLs ATUAL"
echo "---------------------------------------"
cat veramo_backend/urls.py
echo ""

# 3. Parar serviço para manutenção
echo "⏹️ 2. PARANDO SERVIÇO"
echo "--------------------"
...
cp veramo_backend/urls.py veramo_backend/urls.py.backup
...
echo "-----------------------"
python manage.py show_urls | grep -E "(health|companies|demissao|unions|users)" || echo "Erro ao listar rotas"
echo ""
...
echo "📊 Verifique se os problemas 404 foram resolvidos!"
